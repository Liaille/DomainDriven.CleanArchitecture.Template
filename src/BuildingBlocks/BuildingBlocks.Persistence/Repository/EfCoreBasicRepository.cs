...
/// <summary>
/// EF Core 基础读写仓储实现 (CQRS 命令专用)
/// </summary>
/// <typeparam name="TEntity">聚合根类型</typeparam>
/// <typeparam name="TKey">主键类型</typeparam>
/// <typeparam name="TDbContext">数据库上下文类型</typeparam>
public class EfCoreBasicRepository<TEntity, TKey, TDbContext>(TDbContext dbContext)
    : EfCoreReadOnlyRepository<TEntity, TKey, TDbContext>(dbContext), IBasicRepository<TEntity, TKey>
